...
Ahora debo aplicar esta funcion a las 27 variables numericas del dataset La fc lapply me permite hacer eso. lapply toma una lista y aplica una fc especifica a cada elemento de la lista. Como una tabla es una lista de vectores, podemos usar lapply. Por ultimo convertimos el resultado a un dataframe.
